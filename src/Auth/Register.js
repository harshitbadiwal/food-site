...
import { FormGroup, FormControl, Input, InputLabel, Typography, Button, styled, imageListClasses, Grid } from "@mui/material";
...
const Register = () => {
    ...
    const registeruser = async () => {
      ...
      try{ const result = await FirebaseAuth.createUserWithEmailAndPassword(email, password);
